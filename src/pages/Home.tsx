    ...
    <div>
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 pt-24 text-center">
        <p className="animate-drift-up font-data text-xs uppercase tracking-[0.3em] text-[var(--color-bronze-glow)]">
          Каталог 2026 · 6 брендов · 12 моделей
        </p>
        <h1 className="animate-drift-up mt-6 max-w-3xl text-balance font-display text-5xl font-bold leading-[1.05] text-[var(--color-cloud)] sm:text-6xl lg:text-7xl" style={{ animationDelay: "0.1s" }}>
          Автомобили, которые <span className="text-[var(--color-bronze-glow)]">заслуживают</span> тишины в зале
        </h1>
        <p className="animate-drift-up mt-6 max-w-xl text-balance font-body text-base text-[var(--color-cloud-dim)] sm:text-lg" style={{ animationDelay: "0.2s" }}>
          Подбираем автомобиль так же тщательно, как его собирают: по бренду, региону и дилеру — без лишнего шума.
        </p>

        <div className="animate-drift-up mt-10" style={{ animationDelay: "0.3s" }}>
          <HeroCar />
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 sm:px-8 lg:px-12">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl font-semibold text-[var(--color-cloud)] sm:text-4xl">
              Три модели этого сезона
            </h2>
          </div>
